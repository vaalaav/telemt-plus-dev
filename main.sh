...
print_status_panel() {
    ...
    printf "  ${C_DIM}│${C_RESET}  %-12s ${C_WHITE}%-38s${C_RESET}\n" "ОС:" "$os_info"
    printf "  ${C_DIM}│${C_RESET}  %-12s ${C_WHITE}%-38s${C_RESET}\n" "Аптайм:" "$uptime_info"
    echo -e "  ${C_DIM}│${C_RESET}"
    printf "  ${C_DIM}│${C_RESET}  %-12s ${C_WHITE}%-14s${C_RESET}%-6s ${C_WHITE}%-14s${C_RESET}\n" "CPU:" "$cpu" "RAM:" "$ram"
    printf "  ${C_DIM}│${C_RESET}  %-12s ${C_WHITE}%-38s${C_RESET}\n" "Disk:" "$disk"
    echo -e "  ${C_DIM}│${C_RESET}"
    echo -e "  ${C_DIM}│${C_RESET}  ${C_DIM}Сервисы:${C_RESET}"
    printf "  ${C_DIM}│${C_RESET}    %-16s %s\n" "telemt:" "$st_telemt"
    printf "  ${C_DIM}│${C_RESET}    %-16s %s\n" "telemt-panel:" "$st_panel"
    printf "  ${C_DIM}│${C_RESET}    %-16s %s\n" "Nginx:" "$st_nginx"
    echo -e "  ${C_DIM}│${C_RESET}"
    echo -e "  ${C_DIM}└───────────────────────────────────────────────────────────┘${C_RESET}"
    echo ""
